        ...
        <div >
            ...
            <div className="backt">
                ...
                <div style={{ width: "30%" }} className="input-group">
                    <input type="text" onChange={(e) => setSearch(e.target.value)} className="form-control rounded" placeholder="Search here with ID/Name/Status" aria-label="Search" aria-describedby="search-addon" />
                </div>
                <div className="table-total ttable">
