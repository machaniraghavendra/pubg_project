            ...
            <div>
                        ...
                        <div className="option">
                            ...
                            <a className="btn btnm yes btn-danger" style={{ background: "red" }} onClick={() => {
                                if (conform == true) {
                                    ...
                                    return (getFavourites(), setConform(false), setSure(true))
                                }
                                getFavourites();
                ...
                {sure ?
                    <div className="Popup">
                        ...
                        <div className="option">
                            <a className="btn btn-info yes" style={{ marginLeft: "70%", textAlign: "center" }} onClick={() => { return (setSure(false), setInfo(""), getFavourites()) }}>OK </a>
                        </div>
                    </div> : ""}
