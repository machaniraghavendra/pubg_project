                    ...
                    <div className="card-header">
                        {conform ?
                            <div className="Popup">
                                ...
                                <div className="option">
                                    ...
                                    }}>No <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-emoji-smile" viewBox="0 0 16 16">
                                    ...
                                    }}>Yes <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-emoji-frown" viewBox="0 0 16 16">
                                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                        ...
                        <nav className="navbar navbar-expand-lg navbar-dark nav">
                            <div className="container-fluid">
                                <Link to="/pubg"><img className="logo navbar-brand" style={{width:"50%"}}src="https://na.battlegrounds.pubg.com/wp-content/themes/regionals/assets/images/header/pubg-logo-battlegrounds.png" /></Link>
                                ...
                                <div className="collapse navbar-collapse" id="navbarNav">
                                    <ul className="navbar-nav  ">
                                        <li className="nav-item">
                                            <Link className="nav-link" aria-current="page" to="/tournaments">Tournaments</Link>
                                        </li>
                                        <li className="nav-item">
                                                    ...
                                                    <Link className="nav-link" to="/account">
                                                        {e.userName} &#160;
                                                        {
                                                            localStorage.getItem("profile") == null ? <svg xmlns="http://www.w3.org/2000/svg" width="35" height="33" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
                                                                ...
                                                                <img className="sizeprofile img-fluid" width="30"src={localStorage.getItem("profile")} />
                                                        }</Link>
                                                )
