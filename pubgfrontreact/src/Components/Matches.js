        ...
        <div >
            ...
            {conform ?
                <div className="Popup">
                    ...
                    <div className="option">
                        <a className="btn btnm yes btn-success" onClick={() => { setConform(false) }}>No <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-emoji-smile" viewBox="0 0 16 16">
                        ...
                        <a className="btn btnm yes btn-danger" style={{ background: "red" }} onClick={() => {
                            if (conform == true) {
                                axios.delete("http://localhost:8084/favouritematches/" + forFav).then((res) => {return(setInfo(res.data))});
            ...
            {sure ?
                <div className="Popup">
                    ...
                    <div className="option">
                        <a className="btn btn-info yes" style={{ marginLeft: "70%", textAlign: "center" }} onClick={() => { return(setSure(false),setInfo("") )}}>OK </a>
                    </div>
                </div> : ""}
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://wallpapercave.com/wp/wp2516033.jpg" class="d-block w-100" />
                        </div>
                        <div class="carousel-item">
                            <img src="https://wallpaperaccess.com/full/407341.jpg" class="d-block w-100" />
                        </div>
                        <div class="carousel-item">
            ...
            <div className="row1 ">
                <div  >
                    <h1 className="row2">
                        ...
                        {
                            viewmatchs ? (
                                <button type="button" class="btn view btn-warning" onClick={() => {
                    ...
                    <div class="col-4" >
                        <div class="list-group" id="list-tab" role="tablist" >
                            <a class="list-group-item list-group-itemm list-group-item-action active" id="list-home-list" data-bs-toggle="list" href="#list-home" role="tab" aria-controls="list-home">Clasic</a>
                            <a class="list-group-item list-group-itemm list-group-item-action" id="list-profile-list" data-bs-toggle="list" href="#list-profile" role="tab" aria-controls="list-profile">Battle-Royle</a>
                            <a class="list-group-item list-group-itemm list-group-item-action" id="list-messages-list" data-bs-toggle="list" href="#list-messages" role="tab" aria-controls="list-messages">Clash-Squad Ranked</a>
                            <a class="list-group-item list-group-itemm list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="list-settings">Clash-Squad</a>
                        </div>
                    </div>
                    <div class="col-8">
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fadem fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                                {
                                    matchlist.map((value) => {
                                        if (value.matchId == "PGk1") {
                                            return (
                                                <div>
                                                    ...
                                                    <div id="button">
                                                        <button type="button" class="btn btnm1 btn-success" onClick={() => {
                            ...
                            <div class="tab-pane fadem fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                                {
                                    matchlist.map((value) => {
                                        ...
                                        if (value.matchId == "PGk3") {
                                            return (
                                                <div>
                                                    ...
                                                    <div id="button">
                                                        <button type="button" class="btn btnm1 btn-success" onClick={(e) => {
                                                            axios.post("http://localhost:8084/favouritematches/", {
                                                                "favouriteId": "F3",
                                                                "matchId": value.matchId,
                                                                "matchName": value.matchName,
