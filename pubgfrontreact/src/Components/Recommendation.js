            ...
            <div >
                ...
                <div className="container-xxl margin-top">
                    ...
                    <div>
                        ...
                        <div className="rback">
                            <img src="https://images2.minutemediacdn.com/image/upload/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/shape/cover/sport/pubg--228419855f3339b62879b3cd3147cab1.jpg" className="img-fluid src" alt="..."></img>
                        </div>
                        <div className="back" >
                            {
                                list.map((value) => {
